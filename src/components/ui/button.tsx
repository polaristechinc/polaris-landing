...
/**
 * Shared button style contract.
 *
 * Keeping variants centralized gives us one place to tweak button behavior
 * globally (auth flows today, broader app shell later).
 */
 ...
 *
 * Defaults `type="button"` to avoid accidental form submissions when used
 * outside explicit submit actions.
 */
